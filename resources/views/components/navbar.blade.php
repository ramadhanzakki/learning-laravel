<nav class="bg-gray-800/50">
        ...
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="ml-4 flex items-center md:ml-6">
                ...
                <button type="button" class="relative flex max-w-xs items-center rounded-full focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500 peer">
                ...
                <div class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-gray-800 py-1 outline-1 -outline-offset-1 outline-white/10 shadow-lg transition transition-discrete opacity-0 invisible peer-focus:opacity-100 peer-focus:visible peer-focus:duration-100 peer-focus:ease-out peer-focus-within:opacity-100 peer-focus-within:visible peer-focus-within:duration-100 peer-focus-within:ease-out focus-within:opacity-100 focus-within:visible focus-within:duration-100 focus-within:ease-out hover:opacity-100 hover:visible">
        ...
        <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
            <!-- Current: "bg-gray-950/50 text-white", Default: "text-gray-300 hover:bg-white/5 hover:text-white" -->
            <a href="#" class="block rounded-md bg-gray-950/50 px-3 py-2 text-base font-medium text-white">Dashboard</a>
